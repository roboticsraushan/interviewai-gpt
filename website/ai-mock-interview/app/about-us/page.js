...
const AboutUsPage = () => {
  ...
  const tabContent = {
    mission: {
      ...
      content: (
        <div className="space-y-4">
          <p className="text-base md:text-lg">Interview Prep AI is on a mission to revolutionize interview preparation by providing personalized, intelligent AI coaching tailored to individual career aspirations.</p>
          <p className="text-base md:text-lg">With Interview Prep AI, the goal is to bridge the gap between preparation and success, empowering users to unlock their full potential.</p>
        </div>
      )
    },
    story: {
      ...
      content: (
        <div className="space-y-4">
          Interview Prep AI is building the world’s most personalized AI interview coach – reinventing how individuals prepare for their careers. Unlike traditional prep tools, our product is designed as a voice-based AI coach that simulates real interviews with contextual feedback, enabling users to practice anytime, anywhere, on WhatsApp.<p className="text-base md:text-lg">.</p>
    ...
    approach: {
      ...
      content: (
        <div className="space-y-4">
          <p className="text-base md:text-lg">Interview Prep AI calls or messages you via WhatsApp to gather your role, experience, and goals, storing it under your personalized number. We run a quick initial screening, then our LLM-powered engine generates tailored interview questions with smart follow-ups based on your profile</p>
